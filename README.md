...
- Side‑scrolling obstacle game with gravity and flap mechanics
- Keyboard‑controlled movement (SPACE to flap)
- Multiple difficulty levels with configurable pipe speed and spawn rate
- Score counter and level indicator
- Start and game‑over screens with restart support
